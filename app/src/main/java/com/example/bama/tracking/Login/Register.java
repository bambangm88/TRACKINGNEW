...
public class Register extends AppCompatActivity {
    ...
    EditText txt_username, txt_password, txt_confirm_password, txt_serial;
    Intent intent;

    int success;
    ConnectivityManager conMgr;

    private String url = "http://bambangm.com/" + "register.php";
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (conMgr.getActiveNetworkInfo() != null
                        && conMgr.getActiveNetworkInfo().isAvailable()
                        && conMgr.getActiveNetworkInfo().isConnected()) {
                    checkRegister(username,serial, password, confirm_password);
                } else {
                    Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content),"Tidak Ada Koneksi Internet . .", Snackbar.LENGTH_SHORT);
                    snackbar.show();
    ...
    private void checkRegister(final String username,final String serial, final String password, final String confirm_password) {
